// src/components/cargos/CargoEdit.js
...
export default function CargoEdit({ cargo, onSubmit, onCancel }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await onSubmit(cargo.id, formData);
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div style={styles.modalOverlay}>
      <div style={styles.modal}>
        <div style={styles.modalHeader}>
          <h3 style={styles.modalTitle}>Editar Cargo</h3>
          <button 
            onClick={onCancel} 
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <div style={styles.formActions}>
            ...
            <Button
              ...
              disabled={submitting}
            >
              {submitting ? 'Atualizando...' : 'Atualizar Cargo'}
            </Button>
          </div>
        </form>
      </div>
